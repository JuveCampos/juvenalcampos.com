...
<p class=footnote>Fig. 6 Mapa de la línea con la mínima distancia respecto al CIDE</p>
...
La libería `shiny` nos permite realizar aplicaciones web interactivas utilizando el lenguaje de programación R para ( _parafraseando a Hadley Wickham de RStudio_ ) pasar nuestros superpoderes de R a cualquier usuario que tenga acceso a un navegador web. 
