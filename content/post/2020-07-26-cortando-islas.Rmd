...
<font size="4">Si quieres descargar la base de datos para replicar este ejercicio, puedes descargarla de este [enlace](https://raw.githubusercontent.com/JuveCampos/juveBlog/master/cortando%20Islas/mpios.geojson).</font> 
...
<font size="4">Después obtenemos las coordenadas extremas del territorio de Colima, es decir, el punto máximo en x y en y, el punto mínimo en x y en y, buscando generar un cuadro que englobe al estado sin sus islas. Puedes  obtener estas coordenadas en Google Maps, como muestran las imágenes a continuación: </font>
...
<font size="4">Registramos las coordenadas</font>
