...
Este tipo de tablas son muy agradables para las máquinas y son muy fáciles de filtrar y graficar en librerías como `ggplot2`, sin embargo, son muy incómodas para leer, repíten información y ocupan mas memoria y más páginas para su impresión.
...
Las funciones vistas anteriormente deben formar parte de la caja de herramientas de toda persona que desée trabajar con tablas en R. 

Estas herramientas nos permiten variar el formato de tabla y aprovechar las bondades que nos ofrecen cada uno de estos para nuestras necesidades particulares. 
